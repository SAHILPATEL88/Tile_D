...
import 'package:Tile_App/src/view/screen/reciept.dart';
import 'package:get/get.dart';
import 'package:flutter/material.dart';
import 'package:Tile_App/core/extensions.dart';
import 'package:Tile_App/src/model/product.dart';
import 'package:Tile_App/src/view/widget/empty_cart.dart';
import 'package:Tile_App/src/controller/product_controller.dart';
import 'package:Tile_App/src/view/animation/animated_switcher_wrapper.dart';
...
class CartScreen extends StatelessWidget {
  ...
  String generateReceipt() {
    Map<String, dynamic> receipt = {
      ...
      'items': controller.cartProducts.map((product) {
        return {
          'name': product.name,
          'size': controller.getCurrentSize(product),
          'price': controller.isPriceOff(product) ? product.off : product.price,
      ...
      child: Padding(
        ...
        child: ElevatedButton(
          ...
          onPressed: controller.isEmptyCart
            ...
            await Get.to(() => ReceiptPage(receipt: receipt));
          },
